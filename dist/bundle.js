...
/***/ function(module, exports, __webpack_require__) {
	...
	_mithril2['default'].route(document.getElementById('app'), '/customers', {
	  ...
	  '/customers/:id/reports': (0, _libsProtect2['default'])(_componentsReports2['default'])
	});
	_mithril2['default'].mount(document.getElementById('toast'), _componentsToast2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesMainLess = __webpack_require__(96);
	...
	var _libsStore = __webpack_require__(102);
	...
	var app = {
	  ...
	  state: {
	    ...
	    editReportId: _mithril2['default'].prop(null),
	
	    focusedField: _mithril2['default'].prop(''),
	
	    toast: {
	      buffer: _mithril2['default'].prop([]),
	      message: _mithril2['default'].prop(''),
	      visible: _mithril2['default'].prop('')
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesToastLess = __webpack_require__(100);
	
	var _stylesToastLess2 = _interopRequireDefault(_stylesToastLess);
	...
	exports['default'] = {
	  ...
	  controller: function controller() {
	    ...
	    var timeout = _mithril2['default'].prop(3000);
	    var message = app.state.toast.message;
	    var display = app.state.toast.visible;
	  ...
	  view: function view(ctrl) {
	    ...
	    }, (0, _mithril2['default'])('h4', ctrl.message()));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/less-loader/index.js!./toast.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/autoprefixer-loader/index.js!./../node_modules/less-loader/index.js!./toast.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libsMaterialHelpers = __webpack_require__(105);
	
	var _libsMaterialHelpers2 = _interopRequireDefault(_libsMaterialHelpers);
	
	var _modelsLoginModel = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesCustomersListLess = __webpack_require__(110);
	...
	var _modelsCustomersModel = __webpack_require__(117);
	...
	exports['default'] = {
	  ...
	  view: function view(ctrl) {
	    ...
	    }, [_mithril2['default'].component(_header2['default'], 'CLIENTI'), _mithril2['default'].component(_drawer2['default']), (0, _mithril2['default'])('main', {
	      className: 'mdl-layout__content'
	    }, (0, _mithril2['default'])('div', { className: 'page-content' }, (0, _mithril2['default'])('ul', { className: 'customersList' }, ctrl.customers().map(function (customer) {
...
/***/ function(module, exports) {
	...
	var redrawMat = function redrawMat(element, isInit) {
	  if (!isInit) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesHeaderLess = __webpack_require__(114);
	...
	function subViewReports(ctrl) {
	  return [(0, _mithril2['default'])('div', { className: 'mdl-layout__header-row noPadding' }, [
	  //BACK
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  view: function view(ctrl) {
	    ...
	    return (0, _mithril2['default'])('div', { className: 'mdl-layout__drawer' }, [(0, _mithril2['default'])('span', { className: 'mdl-layout-title' }, 'Menu'), (0, _mithril2['default'])('nav', { className: 'mdl-navigation' }, [(0, _mithril2['default'])('a', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stylesCustomerLess = __webpack_require__(119);
	...
	var _modelsCustomerModel = __webpack_require__(121);
	...
	exports['default'] = {
	  ...
	  controller: function controller() {
	    ...
	    var isNew = _mithril2['default'].route.param('id') === 'new';
	
	    var cardFlipped = _mithril2['default'].prop(app.state.customerEdit());
	    var customer = new _modelsCustomerModel2['default'](app.state.customer());
	
	    var showEdit = _mithril2['default'].prop(true);
	    var showSave = _mithril2['default'].prop(false);
	    var showDelete = _mithril2['default'].prop(false);
	
	    if (!isNew && (!app.state.customer() || app.state.customer()._id !== _mithril2['default'].route.param('id'))) {
	    ...
	    if (isNew) {
	      cardFlipped(true);
	      if (app.state.customer() && app.state.customer()._id) app.state.customer(null);
	    }
	    ...
	    function btnUpdate() {
	      ...
	      if (isNew) {
	        ...
	        _modelsCustomerModel2['default'].insert(customer, function (err, success) {
	        ...
	        _modelsCustomerModel2['default'].update(customer, function (err, success) {
	
	          if (err) return console.log(err);
	
	          customer = new _modelsCustomerModel2['default'](app.state.customer());
	    ...
	    function btnDelete() {
	      ...
	      _modelsCustomerModel2['default'].remove(customer, function (err, success) {
	  ...
	  view: function view(ctrl) {
	    ...
	    //return m('div', {  }, [
	    return (0, _mithril2['default'])('div', { config: _libsRedrawMaterial2['default'].removeContainer }, (0, _mithril2['default'])('div', { className: 'bg' }), (0, _mithril2['default'])('div', { className: 'nav' }, [
	    //BACK
	    (0, _mithril2['default'])('button', {
	      className: 'mdl-button mdl-js-button mdl-button--icon',
	      id: 'btnBack',
	    ...
	    }, (0, _mithril2['default'])('i', { className: 'material-icons' }, 'arrow_back')),
	    //DELETE
	    (0, _mithril2['default'])('button', {
	      className: 'mdl-button mdl-js-button mdl-button--icon',
	    ...
	    (0, _mithril2['default'])('button', {
	      ...
	      className: 'material-icons'
	    }, 'check_circle'))]), (0, _mithril2['default'])('section', { className: 'container' }, (0, _mithril2['default'])('div', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Customer(data) {
	  ...
	  if (data) {
	    ...
	    this.relazioni = _mithril2['default'].prop(data.relazioni || []);
	  } else {
	    this._id = _mithril2['default'].prop(null);
	    this._rev = _mithril2['default'].prop(null);
	    this.codCliente = _mithril2['default'].prop('');
	    this.ragioneSociale = _mithril2['default'].prop('');
	    this.codAgente = _mithril2['default'].prop('');
	    this.indirizzo = _mithril2['default'].prop('');
	    this.citta = _mithril2['default'].prop('');
	    this.provincia = _mithril2['default'].prop('');
	    this.telefono = _mithril2['default'].prop('');
	    this.fax = _mithril2['default'].prop('');
	    this.email = _mithril2['default'].prop('');
	    this.responsabile = _mithril2['default'].prop('');
	    this.attivita = _mithril2['default'].prop('');
	    this.ultimaVisita = _mithril2['default'].prop('');
	    this.relazioni = _mithril2['default'].prop([]);
	  }
	}
	...
	Customer.insert = function (data, callback) {
	  ...
	  (0, _libsRequest2['default'])({
	    method: 'POST',
	    url: _config.urls[_config.env].customer,
	    data: data
	  }, function (err, success) {
	    if (err) {
	      app.showToast('Si è verificato un errore.');
	...
	Customer.remove = function (data, callback) {
	  ...
	  (0, _libsRequest2['default'])({
	    method: 'delete',
	    url: _config.urls[_config.env].customer + '/' + _mithril2['default'].route.param('id') + '?rev=' + data
	  }, function (err, success) {
...
/***/ function(module, exports) {
	...
	exports.InputMaskDefaultMask = InputMaskDefaultMask;
	...
	exports.InputMaskDataType = InputMaskDataType;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Reports(data) {
	  ...
	  this._id = _mithril2['default'].prop(data.doc._id || '');
	  this._rev = _mithril2['default'].prop(data.doc._rev || '');
	  this.idCliente = _mithril2['default'].prop(data.doc.idCliente || '');
	  this.codAgente = _mithril2['default'].prop(data.doc.codAgente || '');
	  this.codCliente = _mithril2['default'].prop(data.doc.codCliente || '');
	  this.data = _mithril2['default'].prop(data.doc.data || '');
	  this.tipoIncontro = _mithril2['default'].prop(data.doc.tipoIncontro || '');
	  this.note = _mithril2['default'].prop(data.doc.note || '');
	}
	...
	Reports.fetch = function (callback) {
	  ...
	  (0, _libsRequest2['default'])({
	    method: 'GET',
	    url: _config.urls[_config.env].reports + '?include_docs=true&key="' + _mithril2['default'].route.param('id') + '"',
	    unwrapSuccess: function unwrapSuccess(response) {
	      return response.rows;
	    },
	    type: Reports
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  controller: function controller(params) {
	    ...
	    var index = _mithril2['default'].prop(params.index);
	    var editId = app.state.editReportId;
	    var data = _mithril2['default'].prop(params.data);
	...
	function viewEdit(ctrl, item, index) {
	  return [(0, _mithril2['default'])('div', { className: 'cd-timeline-img' }, [(0, _mithril2['default'])('img', {
	    ...
	    value: (0, _moment2['default'])(item.data).format('DD/MM/YYYY h:mm'),
	    onblur: _mithril2['default'].withAttr('value', ctrl.setData),
	    config: function config(element, isInit) {
	      if (!isInit) {
	        new _libsInputMask.InputMask().Initialize(document.querySelectorAll(".dateMask"), {
	          mask: _libsInputMask.InputMaskDefaultMask.DateTimeShort,
	...
	function viewStandard(ctrl, item, index) {
	  return [(0, _mithril2['default'])('div', { className: 'cd-timeline-img' }, [(0, _mithril2['default'])('img', { src: item.tipoIncontro === 'V' ? './img/person.svg' : './img/call.svg' })]), (0, _mithril2['default'])('div', {
	    className: 'cd-timeline-content',
	    onclick: ctrl.editItem.bind(ctrl, index)
	  }, [(0, _mithril2['default'])('h2', [(0, _moment2['default'])(item.data).fromNow(), (0, _mithril2['default'])('span', { className: 'dateExt' }, item.codAgente)]), (0, _mithril2['default'])('p', item.note), (0, _mithril2['default'])('span', { className: 'cd-date' }, (0, _moment2['default'])(item.data).format('D MMMM YYYY, h:mm'))])];
	}
	module.exports = exports['default'];
